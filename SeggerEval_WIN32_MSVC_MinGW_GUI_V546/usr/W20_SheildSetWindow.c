...
*
**********************************************************************
*/void W20_SheildSetWindowDisplay(void)
{

}
void W20_SheildSetWindowProcess(void)
{
     switch(WinKeyValue)
     {
...
WM_HWIN Create_W20_SheildSet_Window(void) {
  WM_HWIN hWin;
