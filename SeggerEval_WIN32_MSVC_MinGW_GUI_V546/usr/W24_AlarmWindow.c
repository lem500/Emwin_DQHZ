...
**********************************************************************
*/
//unsigned char shijianxixx[] = "\xe4\xba\x8b\xe4\xbb\xb6\xe4\xbf\xa1\xe6\x81\xaf";//unsigned char shijianzongshu[] = "\xe4\xba\x8b\xe4\xbb\xb6\xe6\x80\xbb\xe6\x95\xb0:";extern unsigned char baojingzongshu[] ;extern unsigned char shoujingg[] = "\xe9\xa6\x96\xe8\xad\xa6:";unsigned char cewenshi[] = "002 \xe6\xb5\x8b\xe6\xb8\xa9\xe5\xbc\x8f ";unsigned char baojingzhii[] = "\xe6\x8a\xa5\xe8\xad\xa6\xe5\x80\xbc:50\xe2\x84\x83";
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {  case WM_PAINT :     GUI_SetColor(GUI_RED);     GUI_FillRect(0,0,480,60);     GUI_SetColor(HFM_HEAD_BK);     GUI_FillRect(0,290,480,320);     GUI_SetBkColor(HFM_COLOR_BK);     GUI_SetFont(&GUI_Fontstay24);     GUI_SetColor(GUI_WHITE);     GUI_SetBkColor(GUI_RED);     GUI_DispStringAt(shoujingg, 1, 31);     GUI_DispStringAt(baojingzongshu, 6, 1);     GUI_DispStringAt("002", 120, 1);     GUI_DispStringAt(cewenshi, 75, 31);     GUI_DispStringAt(baojingzhii, 205, 31);     GUI_SetFont(&GUI_Font16_ASCII);     GUI_DispStringAt("2018-05-16 11:03:01", 355, 35);     GUI_SetColor(HFM_COLOR_BK1);     GUI_FillRect(0,62,480,92);     GUI_SetBkColor(HFM_COLOR_BK1);       GUI_SetColor(GUI_BLACK);     GUI_SetFont(&GUI_Fontstay24);     GUI_DispStringAt("001", 1, 62);     GUI_DispStringAt(cewenshi, 75, 62);     GUI_DispStringAt(baojingzhii, 205, 62);     GUI_SetFont(&GUI_Font16_ASCII);       GUI_DispStringAt("2018-05-16 11:03:01", 355, 66);    GUI_SetColor(GUI_BLACK);     GUI_SetBkColor(HFM_COLOR_BK);     GUI_SetFont(&GUI_Fontstay24);     GUI_DispStringAt("002", 1, 92);     GUI_DispStringAt(cewenshi, 75, 92);     GUI_DispStringAt("003", 75, 92);     GUI_DispStringAt(baojingzhii, 205, 92);     GUI_SetFont(&GUI_Font16_ASCII);       GUI_DispStringAt("2018-05-16 11:03:01", 355, 96);    break;
  case WM_INIT_DIALOG:
    //
...
*
**********************************************************************
*/void W24_AlarmWindowDisplay(void)
{

}
void W24_AlarmWindowProcess(void)
{
     switch(WinKeyValue)
     {
...
WM_HWIN Create_W24_AlarmWim_Window(void) {
  WM_HWIN hWin;
