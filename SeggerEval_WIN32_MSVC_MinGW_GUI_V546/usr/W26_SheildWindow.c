...
*
**********************************************************************
*/void W26_SheildWindowDisplay(void)
{

}
void W26_SheildWindowProcess(void)
{
     switch(WinKeyValue)
     {
...
WM_HWIN Create_W26_SheildWim_Window(void) {
  WM_HWIN hWin;
