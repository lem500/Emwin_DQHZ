...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 17, 10, 251, 30, 0, 0xc, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_1, 2, 40, 206, 28, 0, 0x0, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_2, 5, 70, 60, 28, 0, 0x20, 0 },  { EDIT_CreateIndirect, "Text", ID_EDIT_2, 20, 100, 206, 28, 0, 0x20, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_3, 60, 70, 60, 28, 0, 0x00, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_4, 120, 70, 60, 28, 0, 0x00, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_5, 180, 70, 60, 28, 0, 0x00, 0 },  { TEXT_CreateIndirect, "Text", ID_TEXT_6, 240, 70, 60, 28, 0, 0x00, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    EDIT_SetText(hItem, "");
    EDIT_SetFont(hItem, GUI_FONT_24_1);    EDIT_EnableBlink(hItem, 300, 1);    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_1);    TEXT_SetFont(hItem,&GUI_Fontstay24);    TEXT_SetText(hItem,"");    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_1);    EDIT_EnableBlink(hItem,300,0);    EDIT_SetBkColor(hItem,EDIT_CI_ENABLED,GUI_MAKE_COLOR(0x00808040));    EDIT_SetFont(hItem, GUI_FONT_24_1);    EDIT_SetText(hItem,"");    hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_2);    EDIT_SetFont(hItem,&GUI_Fontstay24);    EDIT_SetBkColor(hItem,EDIT_CI_ENABLED,GUI_MAKE_COLOR(0x00808040));    EDIT_EnableBlink(hItem,300,0);    EDIT_SetText(hItem,"");
