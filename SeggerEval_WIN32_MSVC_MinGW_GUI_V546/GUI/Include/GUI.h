...
*/
int LCDLIN_ROTATE_SetIndexEx (int Index, int LayerIndex);
int LCDLIN_ROTATE_TurnEx     (int Dir, int LayerIndex);
int LCDLIN_ROTATE_Turn       (int Dir);
int LCDLIN_ROTATE_AddDriverEx(const GUI_DEVICE_API * pDriver, int LayerIndex);
int LCDLIN_ROTATE_AddDriver  (const GUI_DEVICE_API * pDriver);
int LCDLIN_ROTATE_SetCallback(void (* pCbOnSelect)(int, int), int LayerIndex);
